        ...
        <div className="card border border-[var(--border-default)] shadow-2xl shadow-black/20">
          ...
          {step === 0 && (
            <div className="animate-fade-in">
              ...
              {inviteState?.success && (
                <div className="mb-4 p-3.5 rounded-xl bg-trust/10 border border-trust/20 animate-fade-in">
              ...
              {inviteState?.message && !inviteState.success && (
                <div className="mb-4 p-3.5 rounded-xl bg-critical/10 border border-critical/20 animate-fade-in">
              ...
              <form action={inviteAction} className="space-y-4">
                <FormField
                  ...
                  errors={inviteState?.errors?.name}
                  required
                />
                <FormField
                  ...
                  errors={inviteState?.errors?.email}
                  required
                />
