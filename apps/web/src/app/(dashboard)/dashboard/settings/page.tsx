  ...
  return (
    <div className="max-w-3xl">
      ...
      <div className="card border border-[var(--border-subtle)] mb-6 animate-fade-in">
        <h2
          className="text-[10px] font-semibold text-navy-400 uppercase tracking-widest mb-5"
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 rounded-xl bg-navy-800/30 border border-[var(--border-subtle)]">
            ...
            <div className="flex items-center gap-2">
              ...
              <span
                className="inline-flex items-center px-2 py-0.5 rounded-md text-[10px] font-semibold uppercase tracking-wider bg-trust/10 text-trust border border-trust/20"
                style={{ fontFamily: "var(--font-mono)" }}
              >
                Active
              </span>
      ...
      <div className="card border border-[var(--border-subtle)] mb-6 animate-fade-in-delay-1">
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 rounded-xl bg-navy-800/30 border border-[var(--border-subtle)]">
            ...
            <span
              className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[10px] font-semibold uppercase tracking-wider bg-trust/10 text-trust border border-trust/20"
              style={{ fontFamily: "var(--font-mono)" }}
            >
      ...
      <div className="card border border-critical/10 animate-fade-in-delay-2">
        <h2
          className="text-[10px] font-semibold text-critical uppercase tracking-widest mb-3"
          style={{ fontFamily: "var(--font-mono)" }}
        >
          Danger zone
        </h2>
        ...
        <button
          disabled
          className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium text-critical/50 bg-critical/5 border border-critical/10 cursor-not-allowed"
        >
          <svg
            width="14"
            height="14"
