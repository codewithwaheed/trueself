...
export function InviteForm() {
    ...
    return (<div className="card border border-[var(--border-subtle)]">
      ...
      {state?.success && (<div className="mb-4 p-3 rounded-xl bg-trust/10 border border-trust/20 animate-fade-in">
      ...
      {state?.message && !state.success && (<div className="mb-4 p-3 rounded-xl bg-critical/10 border border-critical/20 animate-fade-in">
      ...
      <form ref={formRef} action={action} className="space-y-3">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <FormField label="Name" name="name" placeholder="Jane Smith" errors={state?.errors?.name} required/>
          <FormField label="Email" name="email" type="email" placeholder="jane@company.com" errors={state?.errors?.email} required/>
        </div>
        <div className="pt-1">
