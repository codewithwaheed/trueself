...
export function AcceptInviteForm({ token, email, defaultName, }) {
    ...
    return (<>
      ...
      <form action={action} className="space-y-4">
        ...
        <div className="card space-y-4 animate-fade-in-delay-1">
          ...
          <FormField label="Full name" name="name" placeholder="Your name" defaultValue={defaultName} autoComplete="name" autoFocus errors={state?.errors?.name} required/>
          <FormField label="Create password" name="password" type="password" placeholder="Min 8 characters, 1 letter, 1 number" autoComplete="new-password" errors={state?.errors?.password} required/>
        </div>
...
//# sourceMappingURL=accept-invite-form.js.map